...
import '../rendering/point_cloud_renderer.dart';
...
class _PointCloudViewerState extends State<PointCloudViewer> {
  final PointCloudRenderer _renderer = PointCloudRenderer();
    ...
    return Listener(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: CustomPaint(
            painter: _PointCloudPainter(_renderer),
            size: Size.infinite,
          ),
        ),
      ),
...
class _PointCloudPainter extends CustomPainter {
  final PointCloudRenderer renderer;
  
  _PointCloudPainter(this.renderer);
  ...
  @override
  bool shouldRepaint(_PointCloudPainter oldDelegate) => true;
}